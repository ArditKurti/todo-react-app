...
export default class TodosListItem extends React.Component {
      ...
      return (
        <td>
          <form onSubmit={this.onSaveClick.bind(this)}>
            <input className="edit-input" type="text" defaultValue={task} ref="editInput" />
          </form>
        </td>
      )
    }
  ...
  renderActionsSection() {
    ...
    if(this.state.isEditing) {
      return (
        <td>
          <button className="editTodo" onClick={this.onSaveClick.bind(this)}>Save</button>
          <button className="removeTodo" onClick={this.onCancelClick.bind(this)}>Cancel</button>
        </td>
      )
    }
    ...
    return (
      <td>
        <button className="editTodo" onClick={this.onEditClick.bind(this)}>Edit</button>
        <button className="removeTodo" onClick={this.props.deleteTask.bind(this, this.props.task)}>Delete</button>
      </td>
    )
  }
